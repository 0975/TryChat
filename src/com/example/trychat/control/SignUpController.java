...
public class SignUpController {
    ...
    public void submit(ActionEvent event){
        ...
        try {
            ...
            FXMLLoader loader =new FXMLLoader(getClass().getResource("/com/example/trychat/control/userMessage.fxml"));
            root = loader.load();
            ...
            isIn = false;
           Main.getInstance().getConnectServer().sendRegistrationInfo(user.getUserName(),user.getFirstName(),user.getLastName(),user.getAge(),user.getEmail(),user.getPassword());
